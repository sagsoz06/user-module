            ...
            <div class="tab-content">
                <div class="tab-pane active" id="account_tab">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                                {{ Form::normalInput('first_name', trans('user::users.form.first_name'), $errors, $user) }}
                            </div>
                            <div class="col-md-4">
                                {{ Form::normalInput('last_name', trans('user::users.form.last_name'), $errors, $user) }}
                            </div>
                            <div class="col-md-4">
                ...
                <div class="tab-pane" id="password_tab">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {{ Form::normalInputOfType('password', 'old_password', trans('user::users.form.old_password'), $errors) }}
                            </div>
                            <div class="col-md-6">
